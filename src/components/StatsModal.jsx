              ...
              <Card className={ classes.card }>
                ...
                <CardContent>
                  <List className={ classes.list }>
                    ...
                    <ListItem alignItems="flex-start"><ListItemAvatar><Avatar className={ classes.avatar }>Е</Avatar></ListItemAvatar><ListItemText primary="Екатерина" secondary={<React.Fragment><Typography component="span" variant="body2" className={classes.inline} className={ classes.greentypo }>{"Да"}</Typography></React.Fragment>} /></ListItem>
